    ...
    <div class="">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Edit Pinjaman Buku <small>Perpustakaan</small></h2>
                    ...
                    <div class="x_content">
                        @foreach ($joinPj as $ed)
                        <form action="/Pinjaman/Update/{{ $ed->id_pj }}" method="POST"><br>
                            {{ csrf_field() }}
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align">ID<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="id_pj" type="text" value="{{ $ed->id_pj }}" required='required'/>
                                </div>
                            </div>
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align">Tanggal Pinjam<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="pjm" type="date" value="{{ $ed->tgl_pj }}" required='required'/></div>
                            </div>
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align">Tanggal Kembali<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="kmb" type="date" value="{{ $ed->tgl_kmb }}" required='required'/></div>
                            </div>
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align">NIM<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                                    <select name="nim" class="select2_single form-control" tabindex="-1">
                                        <option value="{{ $ed->nim }}">{{ $ed -> nim . ' - ' . $ed -> nama_ang . ' - ' . $ed -> prodi}}</option>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select name="id_pg" class="form-control" required>
                                        <option value="{{ $ed->id_pg }}">{{ $ed -> nama_peg }}</option>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select name="id_bk" class="form-control" required>
                                        <option value="{{ $ed->id_bk }}">{{ $ed -> jd_bk }}</option>
