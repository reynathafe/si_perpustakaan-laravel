        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        @foreach ($joinKmb as $ed)
                        <form action="/Kembali/Update/{{ $ed->id_kmb }}" method="POST" enctype="multipart/form-data"><br>
                            {{ csrf_field() }}
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align"><span class="required"></span></label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="id_kmb" type="hidden" value="{{ $ed->id_kmb }}" required='required'/>
                                </div>
                            </div>
                            <div class="field item form-group">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="jml" type="number" value="{{ $ed->jml_telat }}"/></div>
                            </div>
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select name="id_pj" class="form-control" required='required'>
                                        <option value="{{ $ed->id_pj }}">{{ $ed -> id_pj }}</option>
